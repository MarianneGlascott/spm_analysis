# =========================================================
# Script title: 04_derive_variables_v5.R
...
# ---------------------------------------------------------
# 10b. Brake-wear mass loading transform (Exp 3)
# ---------------------------------------------------------
...
cat("Brake-wear mass loading transform derived (log10_bw_ug_l_plus1).\n\n")
...
derived_variable_summary <- tibble::tibble(
  ...
  description = c(
    ...
    "log10(bw_ug_l + 1) transform for mass-based analyses",
